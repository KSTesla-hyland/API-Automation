...
def users_dropdown_schema(api_respone_context):
    assert RESTResponseUtils().json_schema_validator("TestData/RESTDEMOAPI_TestData/AnalyticsUsersdropdown.json",
...
def location_dropdown_schema(api_respone_context):
    assert RESTResponseUtils().json_schema_validator("TestData/RESTDEMOAPI_TestData/AnalyticsLocationsdropdown.json",
                                                     api_respone_context.get_response_content())